...
//
// - Split shape (current): base file carries language-agnostic AI fields plus
//   `available_languages` + `key_terms_keys`; per-language AI content lives in
//   sister files `{path}.{lang}.json` with shape
...
export function humanTranslation(v, lang) {
...
export function buildContent(v, lang, sister) {
  ...
  if (lang === "ar") {
    ...
    parts.push(humanTranslation(v, lang) || chunkText(v, sister, lang));
